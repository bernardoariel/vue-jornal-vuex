<template>
    ...
    <div class="d-flex flex-column px-3 h-75">
        <textarea placeholder="¿ Que susedió hoy ?">
    ...
    <Fab 
        icon="fa-save"
    />
    <img src="https://es.rollingstone.com/wp-content/uploads/2023/02/luis-alberto-spinetta.jpg" alt="entry-picture" class="img-thumbnail">
</template>
